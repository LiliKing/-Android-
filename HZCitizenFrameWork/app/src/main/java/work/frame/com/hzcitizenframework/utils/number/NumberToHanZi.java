package work.frame.com.hzcitizenframework.utils.number;

public class NumberToHanZi {
    private static final char[] hunit = {'拾', '佰', '仟'};
    private static final char[] vunit = {'万', '亿'};
    private static final char[] digit = {'零', '壹', '贰', '叁', '肆', '伍', '陆',
            '柒', '捌', '玖'}; // 数字表示
